...
export default function PrePdfPendingPage() {
  return <Table>
    <TableHeader>
      <TableRow>
    ...
    <TableBody>
      <TableRow>
        ...
        <TableCell className="text-right"><Button size="sm" className="w-fit bg-blue-500 hover:bg-blue-600 m-0">View</Button></TableCell>
      </TableRow>
      <TableRow>
