...
--> statement-breakpoint
CREATE TABLE `userSourceIncome_Deductions` (
	`id` int AUTO_INCREMENT NOT NULL,
	`user_id` char(10) NOT NULL,
	`wages` int,
	`spouse_wages` int,
...
ALTER TABLE `userSourceIncome_Deductions` ADD CONSTRAINT `userSourceIncome_Deductions_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
